    ...
    return (
        ...
        >
            <div className="container-custom relative z-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-16 max-w-5xl mx-auto items-center px-4 sm:px-0">
                    ...
                    >
                        ...
                        <h3 className="text-2xl sm:text-3xl font-bold text-[var(--text-primary)] mb-4 sm:mb-6">
                            Let's Connect
                        </h3>

                        {/* Description */}
                        <p className="text-[var(--text-secondary)] text-sm sm:text-base leading-relaxed mb-6 sm:mb-8">
                        ...
                        <div className="space-y-4 sm:space-y-5">
                            ...
                            <div className="flex items-start gap-3 sm:gap-4">
                                <div className="mt-1">
                                    <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-lg bg-gradient-to-br from-red-500 to-pink-500 flex items-center justify-center">
                                ...
                                <div>
                                    ...
                                    <a
                                        ...
                                        className="text-[var(--text-primary)] text-sm sm:text-base font-medium hover:text-primary-400 transition-colors break-all"
                                    >
                            ...
                            <div className="flex items-start gap-3 sm:gap-4">
                                <div className="mt-1">
                                    <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-lg bg-gradient-to-br from-purple-500 to-indigo-600 flex items-center justify-center">
                                        <svg className="w-4 h-4 sm:w-5 sm:h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div>
                                    <p className="text-[var(--text-secondary)] text-xs sm:text-sm mb-1">Location</p>
                        ...
                        <div className="flex items-center gap-3 sm:gap-4 mt-8 sm:mt-10">
                            <a
                                ...
                                className="w-11 h-11 sm:w-12 sm:h-12 bg-[var(--bg-secondary)] border border-[var(--border-color)] rounded-lg flex items-center justify-center text-[var(--text-secondary)] hover:text-primary-400 hover:border-primary-400 transition-all"
                                aria-label="GitHub"
                            >
                    ...
                    >
                        <form
                            ...
                            className="bg-[var(--bg-secondary)] rounded-2xl p-4 sm:p-5 border border-[var(--border-color)] shadow-xl max-w-md mx-auto lg:mx-0"
                        >
                            {/* Name Input */}
                            <div className="mb-4">
