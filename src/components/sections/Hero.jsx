                ...
                <div className="flex flex-col lg:flex-row items-center justify-between gap-14 lg:gap-20 max-w-7xl mx-auto px-6 sm:px-8 lg:px-4">
                    ...
                    <div className="flex-1 text-center lg:text-left order-2 lg:order-1">
                        ...
                        >
                            {/* Primary — Resume */}
                            <div
                                className="relative inline-flex h-12 w-48 font-orbitron text-sm font-semibold tracking-widest uppercase text-[var(--bg-primary)] bg-primary-400 rounded shadow-[var(--shadow-glow)] hover:shadow-[var(--shadow-glow-lg)] overflow-hidden"
                                onMouseEnter={() => setResumeHover(true)}
                                onMouseLeave={() => setResumeHover(false)}
                            >
                                {/* Default State — "Resume" text */}
                                <div
                                    style={{
                                        position: 'absolute',
                                        inset: 0,
                                        ...
                                        gap: '0.5rem',
                                        zIndex: 2,
                                        transform: resumeHover ? 'translate3d(-100%, 0, 0)' : 'translate3d(0, 0, 0)',
                                        WebkitTransform: resumeHover ? 'translate3d(-100%, 0, 0)' : 'translate3d(0, 0, 0)',
                                        transition: 'transform 0.5s cubic-bezier(0.23, 1, 0.32, 1)',
                                        WebkitTransition: '-webkit-transform 0.5s cubic-bezier(0.23, 1, 0.32, 1)',
                                ...
                                {/* Hover State — Preview + Download icons sliding in from right */}
                                <div
                                    ...
                                    style={{
                                        ...
                                        display: 'flex',
                                        zIndex: 1,
                                        transform: resumeHover ? 'translate3d(0, 0, 0)' : 'translate3d(100%, 0, 0)',
                                        WebkitTransform: resumeHover ? 'translate3d(0, 0, 0)' : 'translate3d(100%, 0, 0)',
                                        transition: 'transform 0.5s cubic-bezier(0.23, 1, 0.32, 1)',
                                        WebkitTransition: '-webkit-transform 0.5s cubic-bezier(0.23, 1, 0.32, 1)',
                                        willChange: 'transform',
                                    }}
